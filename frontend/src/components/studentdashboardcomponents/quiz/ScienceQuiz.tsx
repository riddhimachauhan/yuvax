...
export default function ScienceQuiz({ onClose }: ScienceQuizProps) {
  ...
  if (showResults) {
    ...
    return (
      <div className=" bg-white flex items-center mt-8 justify-center relative overflow-hidden w-full rounded-3xl">
        ...
        <div className="absolute bottom-1/3 left-1/4 text-2xl opacity-40">
          🍄
        </div>
        <div className="absolute top-1/3 right-1/4 text-3xl opacity-50">⏳</div>

        {/* Results card */}
        <div className="rounded-3xl shadow-2xl max-w-2xl w-full h-[90vh] overflow-y-auto p-6 md:p-8 relative text-center border border-gray-200">
          {/* Close button */}
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-gray-500 hover:text-gray-900 cursor-pointer z-10"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          {/* Percentage */}
          <div className="mb-2">
            <h2 className="text-5xl md:text-6xl font-bold text-[#D148D1]">
              {percentage}%
            </h2>
          </div>
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              ...
              <span className="font-semibold">
                {formatMMSS(elapsedTotalSeconds)}
              </span>
              {remainingSeconds === 0 && (
          ...
          {/* Message */}
          <p className="text-lg text-gray-500 mb-6">Fantastic Job! 🎉</p>
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            {[
              ...
              <div key={item.label} className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#6798FF] to-[#A655FF] flex flex-col items-center justify-center text-white p-2 mb-1 shadow-md">
          ...
          <div className="flex items-center justify-center gap-3">
            <Button
              ...
              className="px-6 py-4 bg-gradient-to-r cursor-pointer from-[#FF842C] to-[#F73D94] hover:from-orange-600 hover:to-red-600 text-white rounded-lg font-semibold text-base"
            >
              🎮 Play Again!
            </Button>
            <Button
              onClick={handlePlayAgain}
              className="px-6 py-4 bg-gradient-to-r cursor-pointer from-[#92FF2C] to-[#3DD8F7] hover:from-green-600 hover:to-green-600 text-white rounded-lg font-semibold text-base"
            >
              🔂 View Report
            </Button>
          </div>
  ...
  return (
    <div className="h-screen  flex items-center justify-center p-4 relative overflow-hidden">
      {/* Main quiz card */}
      <div className="relative    bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden px-8 py-6 max-w-4xl w-full max-h-[95vh] flex flex-col">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="text-center mb-4 flex-shrink-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
              ...
              <span className="px-2 py-1 bg-orange-500 text-white rounded-md text-xs font-medium">
                Intermediate
              </span>
              <span className="px-2 py-1 bg-[#FFEBA6] text-gray-900 rounded-md text-xs font-semibold">
                +250 XP
              </span>
            ...
            {/* Progress bar */}
            <div className="w-full h-2 rounded-full mb-2 overflow-hidden bg-gray-100">
              <div
          ...
          <div className="flex-1 overflow-y-auto">
            {/* Question */}
            <div className="border-4 border-orange-400 rounded-2xl p-4 mb-4 bg-orange-50/30 relative">
              ...
              <div className="flex items-center gap-3 mt-2">
                <div className="text-3xl md:text-4xl">{question.icon}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {question.options.map((option) => (
                ...
                >
                  <div className="w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold bg-[#FFEBA6] text-gray-900 flex-shrink-0">
                    {option.id}
                  </div>
          ...
          <div className="flex items-center justify-between flex-shrink-0 pt-4">
            <Button
              ...
              variant="outline"
              className="px-4 py-2 border-2 cursor-pointer border-gray-300 text-gray-700 hover:bg-gray-50 rounded-xl font-medium bg-transparent disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <Button
              ...
              className="px-6 py-2 bg-black cursor-pointer text-white hover:bg-gray-900 rounded-xl font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Submit
